  ...
  document.querySelector("#dataset-detail").innerHTML = `
    ...
    <div class="detail-grid">
      <div class="detail-main">
        ...
        <section><h2>Standardization plan</h2><div class="standard-note"><strong>${pretty(dataset.standardization.status)}</strong><code>${escapeHtml(dataset.standardization.profile)}</code><p>${escapeHtml(dataset.standardization.notes)}</p></div></section>${prepareSection}${conversionExampleSection}${outputPreviewSection}
